...
class ApolloClient(object):
    ...
    def __init__(self, app_id, cluster='default', config_server_url='http://47.110.5.120:18022', interval=60, ip=None):
    ...
    def _cached_http_get(self, key, default_val, namespace='application'):
        ...
        if r.ok:
            ...
            logging.info("开始读取app_info的信息 --> {}".format(namespace))
        else:
    ...
    def _long_poll(self):
        ...
        logging.info('Long polling returns %d: url=%s', r.status_code, r.request.url)
